...
Le kit de développement Quantum prend en charge les fonctionnalités numériques via le [`Microsoft.Quantum.Numerics`](https://www.nuget.org/packages/Microsoft.Quantum.Numerics) package NuGet.
...
Pour exécuter l' [`CustomModAdd`](https://github.com/microsoft/Quantum/tree/master/samples/numerics/CustomModAdd) exemple :
