...
Lorsqu’il est associé à un contrôle de Flow, les fonctions de manipulation de tableau telles que <xref:microsoft.quantum.arrays.zip> peuvent offrir un moyen puissant d’exprimer des programmes Quantum :
