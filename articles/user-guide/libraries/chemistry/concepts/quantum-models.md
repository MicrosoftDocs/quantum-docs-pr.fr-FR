...
C’est ce que l’on appelle la approximation de la Born-Oppenheimer et elle tend à être valide pour le spectre d’énergie de faible énergie de $ \hat{H} $, car la masse des électrons est d’environ 1/1836 $ la masse d’une protons.
...
D’autres jeux de base, tels que les vagues planes ou les orbites en temps réel, peuvent être utilisés et, pour plus de détails, nous faisons référence au lecteur curieux pour le texte standard [« moléculaire Electronic-Structure théorie »](https://onlinelibrary.wiley.com/doi/book/10.1002/9781119019572) par Helgaker.
