...
- [Installer Q# pour C#](xref:microsoft.quantum.install.cs) : choisissez cet environnement si vous souhaitez combiner C# et Q# pour créer un programme hôte en C# qui appelle des opérations en Q#.
- [Installer Q# pour Python](xref:microsoft.quantum.install.python) : choisissez cet environnement si vous souhaitez combiner Python et Q# pour créer un programme hôte en Python qui appelle des opérations en Q#.
- [Installer Q# pour Jupyter Notebook](xref:microsoft.quantum.install.jupyter) : choisissez cet environnement pour exécuter du code Q# dans des cellules avec du texte incorporé ou créer des tutoriels interactifs sur l’informatique quantique. Ne choisissez pas cet environnement si vous souhaitez combiner Q# avec un programme hôte classique externe.
