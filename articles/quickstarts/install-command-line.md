---
title: 'Développer avec des applications :::no-loc(Q#)::: dans un IDE'
description: 'Découvrez comment créer une application :::no-loc(Q#)::: qui s’exécute à partir de l’invite de commandes.'
author: bradben
ms.author: v-benbra
ms.date: 8/20/2020
ms.topic: article
...
---
# <a name="develop-with-no-locq-applications-in-an-ide"></a><span data-ttu-id="c0972-103">Développer avec des applications :::no-loc(Q#)::: dans un IDE</span><span class="sxs-lookup"><span data-stu-id="c0972-103">Develop with :::no-loc(Q#)::: applications in an IDE</span></span>

<span data-ttu-id="c0972-104">Les programmes :::no-loc(Q#)::: peuvent s’exécuter seuls et sans pilote dans un langage hôte comme C#, F# ou Python.</span><span class="sxs-lookup"><span data-stu-id="c0972-104">:::no-loc(Q#)::: programs can run on their own, without a driver in a host language like C#, F#, or Python.</span></span> <span data-ttu-id="c0972-105">Vous pouvez développer des applications :::no-loc(Q#)::: dans Visual Studio Code (VS Code), Visual Studio, Visual Studio Codespaces, ou avec n’importe quel éditeur/IDE et exécuter des applications à partir de la console .NET.</span><span class="sxs-lookup"><span data-stu-id="c0972-105">You can develop :::no-loc(Q#)::: applications in Visual Studio Code (VS Code), Visual Studio, Visual Studio Codespaces, or with any editor/IDE and run applications from the .NET console.</span></span> 
...
## <a name="develop-with-no-locq"></a><span data-ttu-id="c0972-127">Développer avec :::no-loc(Q#):::</span><span class="sxs-lookup"><span data-stu-id="c0972-127">Develop with :::no-loc(Q#):::</span></span>
...
1. <span data-ttu-id="c0972-131">Cliquez sur **Affichage** -> **Palette de commandes** et sélectionnez **:::no-loc(Q#)::: : Créer un projet**.</span><span class="sxs-lookup"><span data-stu-id="c0972-131">Click **View** -> **Command Palette** and select **:::no-loc(Q#):::: Create New Project**.</span></span>
...
<span data-ttu-id="c0972-135">Examinez le projet.</span><span class="sxs-lookup"><span data-stu-id="c0972-135">Inspect the project.</span></span> <span data-ttu-id="c0972-136">Vous devriez voir un fichier source nommé `Program.qs`. Il s’agit d’un programme :::no-loc(Q#)::: qui définit une opération simple pour afficher un message dans la console.</span><span class="sxs-lookup"><span data-stu-id="c0972-136">You should see a source file named `Program.qs`, which is a :::no-loc(Q#)::: program that defines a simple operation to print a message to the console.</span></span>
...
<span data-ttu-id="c0972-144">Vérifiez votre installation de Visual Studio en créant une application :::no-loc(Q#)::: `Hello World`.</span><span class="sxs-lookup"><span data-stu-id="c0972-144">Verify your Visual Studio installation by creating a :::no-loc(Q#)::: `Hello World` application.</span></span>

<span data-ttu-id="c0972-145">Pour créer une application :::no-loc(Q#)::: :</span><span class="sxs-lookup"><span data-stu-id="c0972-145">To create a new :::no-loc(Q#)::: application:</span></span>
...
2. <span data-ttu-id="c0972-147">Tapez `:::no-loc(Q#):::` dans la zone de recherche, sélectionnez **Application :::no-loc(Q#):::** , puis cliquez sur **Suivant**.</span><span class="sxs-lookup"><span data-stu-id="c0972-147">Type `:::no-loc(Q#):::` in the search box, select **:::no-loc(Q#)::: Application** and click **Next**.</span></span>
...
<span data-ttu-id="c0972-156">Vérifiez votre installation en créant une application :::no-loc(Q#)::: `Hello World`.</span><span class="sxs-lookup"><span data-stu-id="c0972-156">Verify your installation by creating a :::no-loc(Q#)::: `Hello World` application.</span></span>
...
1. <span data-ttu-id="c0972-158">Accédez au répertoire de l’application :</span><span class="sxs-lookup"><span data-stu-id="c0972-158">Navigate to the application directory:</span></span>
    ...
    <span data-ttu-id="c0972-159">Ce répertoire doit maintenant contenir un fichier `Program.qs`. Il s’agit d’un programme :::no-loc(Q#)::: qui définit une opération simple pour afficher un message dans la console.</span><span class="sxs-lookup"><span data-stu-id="c0972-159">This directory should now contain a file `Program.qs`, which is a :::no-loc(Q#)::: program that defines a simple operation to print a message to the console.</span></span> <span data-ttu-id="c0972-160">Vous pouvez modifier ce modèle avec un éditeur de texte et le remplacer par vos propres applications quantiques.</span><span class="sxs-lookup"><span data-stu-id="c0972-160">You can modfiy this template with a text editor and overwrite it with your own quantum applications.</span></span> 
