...
Il est facile de vérifier que \begin{align} a ^ \dagger_j & = \begin{bmatrix}0 & 1 \\\ 0 & 0 \end{bmatrix} = \frac{X_j + iY_j}{2}, \nonumber\\\\ a_j & = \begin{bmatrix}0 & 0 \\\ 1 & 0 \end{ bmatrix} = \frac{X_j-iY_j}{2}, \end{align} où $X _J $ et $Y _J $ sont les opérateurs Pauli-$X $ et-$Y $ agissant sur qubit $j $.
...
Étant donné que fermions est antisymmetic, nous savons que $a ^ \dagger_j a ^ \dagger_k =-a ^ \dagger_k a ^ \dagger_j $ pour any $j $ et $k $.
