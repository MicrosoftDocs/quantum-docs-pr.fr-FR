...
Ce fichier est basé sur ou intègre des éléments issus des projets listés ci-dessous (adresse IP tierce). La mention de droits d'auteur d’origine et la licence sous laquelle Microsoft a reçu cette adresse IP tierce sont définies ci-dessous. Ces licences et mentions sont fournies à titre d’information uniquement. Microsoft vous accorde la licence d’adresse IP de tiers dans le cadre des termes du contrat de licence pour le produit Microsoft. Microsoft se réserve tous les autres droits non expressément accordés par le présent contrat, que ce soit par implication, par préclusion ou autre.
...
## <a name="yamldotnetsigned-notices-and-information"></a>INFORMATIONS et avis YamlDotNet. signed
---------------------------------------
...
## <a name="xunitrunnervisualstudio-notices-and-information"></a>INFORMATIONS et avis xUnit. Runner. VisualStudio
---------------------------------------
Copyright (c) .NET Foundation et contributeurs tous droits réservés
...
À moins que cela ne soit requis par la loi en vigueur ou accepté par écrit, les logiciels distribués dans le cadre de la licence sont distribués sur une base « en l’État », sans aucune garantie ni condition de quelque nature que ce soit, expresse ou implicite.
Consultez la licence pour la langue spécifique qui régit les autorisations et limitations dans le cadre de la licence.



## <a name="xunitrunnerconsole-notices-and-information"></a>INFORMATIONS et avis xUnit. Runner. console
---------------------------------------
Copyright (c) .NET Foundation et contributeurs tous droits réservés
...
## <a name="xunitextensibilityexecution-notices-and-information"></a>xUnit. Extensibility. informations et avis d’exécution
---------------------------------------
Copyright (c) .NET Foundation et contributeurs tous droits réservés
...
## <a name="xunitextensibilitycore-notices-and-information"></a>INFORMATIONS et avis xUnit. Extensibility. Core
---------------------------------------
Copyright (c) .NET Foundation et contributeurs tous droits réservés
...
## <a name="xunitcore-notices-and-information"></a>INFORMATIONS et avis xUnit. Core
---------------------------------------
Copyright (c) .NET Foundation et contributeurs tous droits réservés
...
## <a name="xunitassert-notices-and-information"></a>INFORMATIONS et avis xUnit. Assert
---------------------------------------
Copyright (c) .NET Foundation et contributeurs tous droits réservés
...
## <a name="xunitanalyzers-notices-and-information"></a>MENTIONs et informations sur xUnit. Analyzers
---------------------------------------
Copyright (c) .NET Foundation et contributeurs tous droits réservés
...
## <a name="xunitabstractions-notices-and-information"></a>AVERTISSEMENTS et indications xUnit. Abstracts
---------------------------------------
Copyright (c) .NET Foundation et contributeurs tous droits réservés
...
## <a name="xunit-notices-and-information"></a>INFORMATIONS et avis xUnit
---------------------------------------
Copyright (c) .NET Foundation et contributeurs tous droits réservés
...
## <a name="managedesent-notices-and-information"></a>INFORMATIONS et avis ManagedEsent
---------------------------------------
Licence publique Microsoft (MS-PL)

Cette licence régit l’utilisation du logiciel associé. Si vous utilisez le logiciel, vous acceptez cette licence. Si vous n’acceptez pas la licence, n’utilisez pas le logiciel.

1. Définitions

Les termes « reproduire », « reproduction », « œuvres dérivées » et « distribution » ont la même signification que dans la loi américaine sur les droits d’auteur.

Une « contribution » est le logiciel d’origine, ou tout ajout ou modification apportée au logiciel.

Un « contributeur » est toute personne qui distribue sa contribution dans le cadre de cette licence.

Les « brevets sous licence » sont les revendications de brevet d’un contributeur qui lisent directement sur sa contribution.
...
(A) pas de licence de marque commerciale-cette licence ne vous accorde pas le droit d’utiliser le nom, le logo ou les marques de contributeurs.

(B) si vous faites une demande de brevet contre un contributeur sur des brevets que vous revendiquez comme étant violés par le logiciel, votre licence de brevet de ce contributeur au logiciel se termine automatiquement.

(C) si vous distribuez une partie du logiciel, vous devez conserver toutes les mentions de droits d’auteur, de brevets, de marques déposées et d’attribution présentes dans le logiciel.
...
## <a name="fsharpcharting-notices-and-information"></a>INFORMATIONS et avis sur FSharp. Charting
---------------------------------------
La licence MIT (MIT)
...
LE LOGICIEL EST FOURNI « EN L’ÉTAT », SANS GARANTIE D’AUCUNE SORTE, EXPRESSE OU IMPLICITE, Y COMPRIS MAIS SANS S’Y LIMITER, LES GARANTIES DE QUALITÉ MARCHANDE, D’ADÉQUATION À UN USAGE PARTICULIER ET DE NON-CONTREFAÇON. EN AUCUN CAS, LES AUTEURS OU LES TITULAIRES DE DROITS D’AUTEUR NE SONT TENUS RESPONSABLES D’AUCUNE RÉCLAMATION, INDEMNISATION OU AUTRE RESPONSABILITÉ, QU’IL S’AGISSE D’UNE ACTION CONTRACTUELLE, D’UN DÉLIT OU D’UN AUTRE CAS, QUI RÉSULTE DE, DE OU EN RELATION AVEC LE LOGICIEL OU L’UTILISATION OU D’AUTRES TRANSACTIONS DANS LE LOGICIEL.
Les versions packagées de ce logiciel peuvent inclure des copies de OxyPlot. Core. dll et OxyPlot. GtkSharp. dll, avec la licence ci-dessous.
...
## <a name="fscheck-notices-and-information"></a>INFORMATIONS et avis FsCheck
---------------------------------------
Copyright (c) 2008-2014, Kurt Schelfthout

Tous droits réservés.

La redistribution et l’utilisation des formes source et binaire, avec ou sans modification, sont autorisées, à condition que les conditions suivantes soient remplies :

* Les redistributions du code source doivent conserver la mention de droits d’auteur ci-dessus, cette liste de conditions et l’exclusion de responsabilité suivante.
...
## <a name="fparsec-notices-and-information"></a>INFORMATIONS et avis FParsec
---------------------------------------
