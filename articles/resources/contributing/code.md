...
Localement, les tests unitaires peuvent être exécutés à l’aide de l’Explorateur de tests Visual Studio ou de la `dotnet test` commande, afin que vous puissiez vérifier votre contribution avant d’ouvrir une demande de tirage (pull request).
