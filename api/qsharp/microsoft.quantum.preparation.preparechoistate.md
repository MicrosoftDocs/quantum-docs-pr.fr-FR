...
Prépare l’État Choi – Jamiłkowski pour une opération donnée sur des registres de référence et cibles donnés.
...
L’opération $ \Lambda $ dont l’État Choi – Jamiłkowski $J (\Lambda)/2 ^ N $ doit être préparée, où $N $ est le nombre de qubits sur lequel `op` agit.
