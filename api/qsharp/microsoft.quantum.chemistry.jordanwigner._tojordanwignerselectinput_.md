...
ms.locfileid: "98839170"
---
# <a name="_tojordanwignerselectinput_-function"></a>_ToJordanWignerSelectInput_ fonction)
...
## <a name="output--qubitqubitqubitlittleendianlittleendian--unit--is-adj--ctl"></a>Sortie : ([qubit](xref:microsoft.quantum.lang-ref.qubit),[qubit](xref:microsoft.quantum.lang-ref.qubit)[],[qubit](xref:microsoft.quantum.lang-ref.qubit)[],[LittleEndian](xref:Microsoft.Quantum.Arithmetic.LittleEndian),[LittleEndian](xref:Microsoft.Quantum.Arithmetic.LittleEndian)[]) => [unité](xref:microsoft.quantum.lang-ref.unit)  est Adj + CTL
