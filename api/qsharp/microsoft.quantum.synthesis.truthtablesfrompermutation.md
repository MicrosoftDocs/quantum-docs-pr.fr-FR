...
ms.locfileid: "98855268"
---
# <a name="truthtablesfrompermutation-function"></a>TruthTablesFromPermutation fonction)
...
Collecter toutes les fonctions pour les portes contrôlées en pliant tous les index de variables
...
## <a name="output--bigintint"></a>Sortie : ([bigint](xref:microsoft.quantum.lang-ref.bigint),[int](xref:microsoft.quantum.lang-ref.int)) []
