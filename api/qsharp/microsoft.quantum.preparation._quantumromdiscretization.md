...
ms.locfileid: "98842478"
---
# <a name="_quantumromdiscretization-function"></a>_QuantumROMDiscretization fonction)
...
## <a name="output--doubleintint"></a>Sortie : ([double](xref:microsoft.quantum.lang-ref.double),[int](xref:microsoft.quantum.lang-ref.int)[],[int](xref:microsoft.quantum.lang-ref.int)[])
