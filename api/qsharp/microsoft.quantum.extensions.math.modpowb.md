...
---
# <a name="modpowb-function"></a>ModPowB fonction)
...
> [!WARNING]
> ModPowB est déconseillé. Utilisez plutôt <xref:Microsoft.Quantum.Math.ModPowL>.
>
> Utilisez @"microsoft.quantum.math.modpowl".
...
### <a name="exponent--bigint"></a>exposant : [bigint](xref:microsoft.quantum.lang-ref.bigint)
