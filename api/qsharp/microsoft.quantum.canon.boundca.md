...
### <a name="operations--t--unit-adj--ctl"></a>opérations : 't => [unité](xref:microsoft.quantum.lang-ref.unit) Adj + CTL []

Séquence d’opérations à effectuer sur une entrée donnée.



## <a name="output--t--unit-adj--ctl"></a>Sortie : 't = [> Adj](xref:microsoft.quantum.lang-ref.unit) + CTL
