...
---
# <a name="continuousdistribution-user-defined-type"></a>Type défini par l’utilisateur ContinuousDistribution
...
Représente une distribution de probabilité Student sur des nombres réels.
...
### <a name="sample--unit--double"></a>Exemple : [unité](xref:microsoft.quantum.lang-ref.unit) => [double](xref:microsoft.quantum.lang-ref.double) 
