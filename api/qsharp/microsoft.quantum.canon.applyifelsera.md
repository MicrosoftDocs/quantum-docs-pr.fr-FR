...
### <a name="zeroop--t--unit-adj"></a>zeroOp : t => ajustement d' [unité](xref:microsoft.quantum.lang-ref.unit)
...
### <a name="oneop--u--unit-adj"></a>oneOp : 'U => ajustement d' [unité](xref:microsoft.quantum.lang-ref.unit)
