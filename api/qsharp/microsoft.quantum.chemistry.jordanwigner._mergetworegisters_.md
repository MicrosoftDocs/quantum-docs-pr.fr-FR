...
ms.locfileid: "96215501"
---
# <a name="_mergetworegisters_-operation"></a>Opération _MergeTwoRegisters_
...
### <a name="oracle--qubitqubit--unit--is-adj--ctl"></a>Oracle : ([qubit](xref:microsoft.quantum.lang-ref.qubit)[],[qubit](xref:microsoft.quantum.lang-ref.qubit)[]) => [unité](xref:microsoft.quantum.lang-ref.unit)  est Adj + CTL




### <a name="nsystemqubits--int"></a>nSystemQubits : [entier](xref:microsoft.quantum.lang-ref.int)
