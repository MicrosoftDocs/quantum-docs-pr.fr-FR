...
ms.locfileid: "98857782"
---
# <a name="standardtransformation-function"></a>StandardTransformation fonction)
...
### <a name="variate--double"></a>variantes : [double](xref:microsoft.quantum.lang-ref.double)
