...
---
# <a name="_estimatederivativewithparametershift-operation"></a>Opération de _EstimateDerivativeWithParameterShift
...
### <a name="parameters--doubledouble"></a>paramètres : ([double](xref:microsoft.quantum.lang-ref.double)[],[double](xref:microsoft.quantum.lang-ref.double)[])
