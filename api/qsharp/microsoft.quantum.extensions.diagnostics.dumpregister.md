...
ms.locfileid: "98849838"
---
# <a name="dumpregister-function"></a>DumpRegister fonction)

Espace de noms : [Microsoft. Quantum. extensions. Diagnostics](xref:Microsoft.Quantum.Extensions.Diagnostics)

Package : [Microsoft. Quantum. QSharp. Core](https://nuget.org/packages/Microsoft.Quantum.QSharp.Core)


> [!WARNING]
> DumpRegister est déconseillé. Utilisez plutôt <xref:Microsoft.Quantum.Diagnostics.DumpRegister>.
>
> Utilisez @"microsoft.quantum.diagnostics.dumpregister".
