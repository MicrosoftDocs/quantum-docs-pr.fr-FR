...
---
# <a name="_trainsequentialclassifieratmodel-operation"></a>Opération de _TrainSequentialClassifierAtModel
...
## <a name="output--sequentialmodel"></a>Sortie : [SequentialModel](xref:Microsoft.Quantum.MachineLearning.SequentialModel)
