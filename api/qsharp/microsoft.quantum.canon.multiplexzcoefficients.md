...
---
# <a name="multiplexzcoefficients-function"></a>MultiplexZCoefficients fonction)
...
Étape d’implémentation des rotations Z contrôlées par multiplication.
...
## <a name="output--doubledouble"></a>Sortie : ([double](xref:microsoft.quantum.lang-ref.double)[],[double](xref:microsoft.quantum.lang-ref.double)[])
