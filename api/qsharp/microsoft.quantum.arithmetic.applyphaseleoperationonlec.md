...
title: Opération ApplyPhaseLEOperationOnLEC
...
ms.locfileid: "98843645"
---
# <a name="applyphaseleoperationonlec-operation"></a>Opération ApplyPhaseLEOperationOnLEC
...
### <a name="op--phaselittleendian--unit--is-ctl"></a>OP : [](xref:Microsoft.Quantum.Arithmetic.PhaseLittleEndian) l' => [unité](xref:microsoft.quantum.lang-ref.unit) PhaseLittleEndian est CTL
