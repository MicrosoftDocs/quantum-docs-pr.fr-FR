...
ms.locfileid: "98844370"
---
# <a name="drawrandompauli-operation"></a>Opération DrawRandomPauli
...
Dessine une valeur Pauli aléatoire.
...
`PauliI`,, `PauliX` `PauliY` Ou avec une `PauliZ` probabilité égale.