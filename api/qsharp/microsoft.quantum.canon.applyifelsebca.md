...
### <a name="trueop--t--unit-adj--ctl"></a>trueOp : 't = [> Adj](xref:microsoft.quantum.lang-ref.unit) + CTL
...
### <a name="falseop--u--unit-adj--ctl"></a>falseOp : 'U [=> Adj](xref:microsoft.quantum.lang-ref.unit) + CTL
