...
---
# <a name="updatedoutputpattern-function"></a>UpdatedOutputPattern fonction)
...
Mettre à jour un modèle de sortie en fonction du masque de la porte.
...
### <a name="pattern--int"></a>modèle : [int](xref:microsoft.quantum.lang-ref.int)
