...
---
# <a name="signedlittleendian-user-defined-type"></a>Type défini par l’utilisateur SignedLittleEndian
...
Type d’un entier signé stocké en Little endian (voir LittleEndian).
