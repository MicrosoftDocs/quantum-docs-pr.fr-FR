...
---
# <a name="_continuedfractionconvergenti-function"></a>_ContinuedFractionConvergentI fonction)
...
Appel récurrent interne pour calculer le GCD avec un lié
...
### <a name="signa--int"></a>signA : [entier](xref:microsoft.quantum.lang-ref.int)




### <a name="signb--int"></a>signB : [entier](xref:microsoft.quantum.lang-ref.int)
...
### <a name="denominatorbound--int"></a>denominatorBound : [entier](xref:microsoft.quantum.lang-ref.int)





## <a name="output--fraction"></a>Sortie : [fraction](xref:Microsoft.Quantum.Math.Fraction)
