...
---
# <a name="intasstring-function"></a>IntAsString fonction)
...
Convertit un nombre entier donné en une représentation sous forme de chaîne équivalente.
...
Pour plus d’informations, consultez [C# Convert. ToString](https://docs.microsoft.com/dotnet/api/system.convert.tostring?view=netframework-4.7.1#System_Convert_ToString_System_Int64_) .