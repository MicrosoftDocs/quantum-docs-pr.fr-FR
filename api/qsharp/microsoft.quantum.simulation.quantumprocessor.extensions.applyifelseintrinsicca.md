...
### <a name="onresultzeroop--unit--unit--is-adj--ctl"></a>onResultZeroOp : l’unité d' [unité](xref:microsoft.quantum.lang-ref.unit) => [Unit](xref:microsoft.quantum.lang-ref.unit) est Adj + CTL




### <a name="onresultoneop--unit--unit--is-adj--ctl"></a>onResultOneOp : l’unité d' [unité](xref:microsoft.quantum.lang-ref.unit) => [Unit](xref:microsoft.quantum.lang-ref.unit) est Adj + CTL
