...
ms.locfileid: "96225191"
---
# <a name="getgeneratorsystemnterms-function"></a>GetGeneratorSystemNTerms fonction)
...
Récupère le nombre de termes dans un `GeneratorSystem` .
...
Nombre de termes dans un `GeneratorSystem` .
