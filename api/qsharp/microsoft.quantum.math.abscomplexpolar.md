...
title: AbsComplexPolar fonction)
...
ms.locfileid: "92708600"
---
# <a name="abscomplexpolar-function"></a>AbsComplexPolar fonction)
...
Retourne la valeur absolue d’un nombre complexe de type `ComplexPolar` .
...
### <a name="input--complexpolar"></a>entrée : [ComplexPolar](xref:Microsoft.Quantum.Math.ComplexPolar)
