...
---
# <a name="cascadecnot-operation"></a>Opération CascadeCNOT
...
> [!WARNING]
> CascadeCNOT est déconseillé. Utilisez plutôt <xref:Microsoft.Quantum.Canon.ApplyCNOTChain>.
>
> Utilisez @"microsoft.quantum.canon.applycnotchain".
