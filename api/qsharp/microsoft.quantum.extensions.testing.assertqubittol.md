...
ms.locfileid: "92702169"
---
# <a name="assertqubittol-operation"></a>Opération AssertQubitTol

Espace de noms : [Microsoft. Quantum. extensions. testing](xref:Microsoft.Quantum.Extensions.Testing)

Packages [](https://nuget.org/packages/)


> [!WARNING]
> AssertQubitTol est déconseillé. Utilisez plutôt <xref:Microsoft.Quantum.Diagnostics.AssertQubitWithinTolerance>.
>
> Utilisez @"microsoft.quantum.diagnostics.assertqubitwithintolerance".
