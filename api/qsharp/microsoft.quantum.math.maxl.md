...
ms.locfileid: "98851286"
---
# <a name="maxl-function"></a>MaxL fonction)
...
Pour plus d’informations, consultez [System. Numerics. BigInteger. Max](https://docs.microsoft.com/dotnet/api/system.numerics.biginteger.max) .