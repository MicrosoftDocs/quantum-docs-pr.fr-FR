...
---
# <a name="_prepareclassification-operation"></a>Opération de _PrepareClassification
...
### <a name="encoder--littleendian--unit-adj--ctl"></a>encodeur : [LittleEndian](xref:Microsoft.Quantum.Arithmetic.LittleEndian) => [Unit](xref:microsoft.quantum.lang-ref.unit) Adj + CTL
