...
ms.locfileid: "98848863"
---
# <a name="complexascomplexpolar-function"></a>ComplexAsComplexPolar fonction)
...
Convertit un nombre complexe de type `Complex` en un nombre complexe de type `ComplexPolar` .
...
## <a name="output--complexpolar"></a>Sortie : [ComplexPolar](xref:Microsoft.Quantum.Math.ComplexPolar)

Nombre complexe $c = r e ^ {i t} $.