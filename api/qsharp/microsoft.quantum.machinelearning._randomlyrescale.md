...
---
# <a name="_randomlyrescale-operation"></a>Opération de _RandomlyRescale
...
Ajuste de façon aléatoire une entrée pour qu’elle soit agrandie ou rétrécie selon un facteur donné.
...
### <a name="scale--double"></a>échelle : [double](xref:microsoft.quantum.lang-ref.double)
