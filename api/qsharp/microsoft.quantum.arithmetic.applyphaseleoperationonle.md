...
### <a name="op--phaselittleendian--unit"></a>OP : [](xref:Microsoft.Quantum.Arithmetic.PhaseLittleEndian) => [unité](xref:microsoft.quantum.lang-ref.unit) PhaseLittleEndian 
